...
function get_titlesplash(){
	...
	"Hey, bet you can't read this entire splash text in one go! Ready? Here I go! The fit- FUUUUUUUUDGE!",
	"Games for Windows...",
	"Brought to you by the choose() function...",
	"TGJAY was cancelled for this...",
	"A groundbreaking Quintuple-A game...",
	"QUICK! I DON'T HAVE MUCH TIME! THE FULL GAME IS COMI-",
	"YAYSUU isn't even my self-insert anymore...",
