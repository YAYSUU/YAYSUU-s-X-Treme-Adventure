...
function scr_player_trybounce(yepdashboing){
	if ((state == playerstates.stomp || (state == playerstates.bounce && char == "C") || (state == playerstates.dash && grounded && yepdashboing)) || (state == playerstates.dash && !grounded) && newstate == state)
	{
		scr_player_dobounce()
	}
}
