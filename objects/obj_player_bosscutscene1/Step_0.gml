...
if global.cutscenestate=0 && x<=160
{
	...
	if global.char="Y"
	{
		sayvoiceline(snd_elecboss1vo_y,"Hey, who's that?","purple","YAYSUU")
		sprite_index=spr_yaysuu_talk_surprised
	}
	else if global.char="T"
	{
		sayvoiceline(snd_elecboss1vo_t,"Hmph. Well, this oughta be somethin'.","orange","Teddy")
...
if global.cutscenestate=5 && !audio_is_playing(snd_elecboss5vo_y) && !audio_is_playing(snd_elecboss5vo_t)
{
	...
	if global.char="Y"
	{
		sayvoiceline(snd_elecboss6vo_y,"...wait.","purple","YAYSUU")
		sprite_index=spr_yaysuu_talk_surprised
	}
	else if global.char="T"
	{
...
if global.cutscenestate=6 && !audio_is_playing(snd_elecboss6vo_y) && !audio_is_playing(snd_elecboss6vo_t)
{
	...
	if global.char="T"
	{
		sayvoiceline(snd_elecboss7vo_t,"Well, I'd like to see you try!","orange","Teddy")
		sprite_index=spr_teddy_talk_assertive
	}
}
