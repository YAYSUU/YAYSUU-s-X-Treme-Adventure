...
if global.cutscenestate=0 && x<=160
{
	...
	if global.char="Y"
	{
		sayvoiceline(snd_elecboss1vo_y,"Hey, who's that?","white","YAYSUU")
		sprite_index=spr_yaysuu_talk_surprised
	}
	else if global.char="T"
	{
		sayvoiceline(snd_elecboss1vo_t,"Hmph. Well, this oughta be somethin'.","white","Teddy")
...
if global.cutscenestate=1 && !audio_is_playing(snd_elecboss1vo_y) && !audio_is_playing(snd_elecboss1vo_t)
{
	...
	sayvoiceline(snd_elecboss2vo,"TARGET SPOTTED.","white","???")
...
if global.cutscenestate=3 && !audio_is_playing(snd_elecboss3vo_y) && !audio_is_playing(snd_elecboss3vo_t)
{
	...
	if global.char="Y"
	{
		sayvoiceline(snd_elecboss4vo_y,"IDENTIFIED AS: `cfYAYSUU. `clAGE: UNKNOWN. SPECIES: STICKLING. DIRECTIVE: IMMEDIATE ELIMINATION","white","???")
		sprite_index=spr_yaysuu_idle
	}
	else if global.char="T"
	{
		sayvoiceline(snd_elecboss4vo_t,"IDENTIFIED AS: `coTEDDY. `clAGE: UNKNOWN. SPECIES: STICKLING. DIRECTIVE: ELIMINATION BY PROXY","white","???")
...
if global.cutscenestate=5 && !audio_is_playing(snd_elecboss5vo_y) && !audio_is_playing(snd_elecboss5vo_t)
{
	...
	if global.char="Y"
	{
		sayvoiceline(snd_elecboss6vo_y,"...wait.","white","YAYSUU")
		sprite_index=spr_yaysuu_talk_surprised
	}
	else if global.char="T"
	{
		sayvoiceline(snd_elecboss6vo_t,"DETECTED FAMILIAL RELATION WITH `cfMAIN TARGET. `clCANNOT BE ALLOWED TO EXIST","white","???")
		sprite_index=spr_teddy_idle
	}
}
if global.cutscenestate=6 && !audio_is_playing(snd_elecboss6vo_y) && !audio_is_playing(snd_elecboss6vo_t)
{
	...
	if global.char="Y"
	{
		sayvoiceline(snd_elecboss7vo_y,"CHALLENGE ACCEPTED. ENGAGING `crSCR BATTLE.GML.","white","???")
		sprite_index=spr_yaysuu_idle
	}
	if global.char="T"
	{
		sayvoiceline(snd_elecboss7vo_t,"Well, I'd like to see you try!","white","Teddy")
		sprite_index=spr_teddy_talk_assertive
	}
}
