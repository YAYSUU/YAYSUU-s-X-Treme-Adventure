if global.indev
{
	...
	{
		draw_text(0, 0, "DEMO MODE")
		draw_text(0, 16, "frameno: " + string(frameno) + " - " + string(nexteventat))
				
		var buttonspacing = 18
				
		draw_sprite_ext(spr_mobilebuttons, 3, 0, 48, 1, 1, 0, obj_player.key_left ? c_white : c_black, 1)
		draw_sprite_ext(spr_mobilebuttons, 0, buttonspacing, 48, 1, 1, 0, obj_player.key_up ? c_white : c_black, 1)
		draw_sprite_ext(spr_mobilebuttons, 2, buttonspacing*2, 48, 1, 1, 0, obj_player.key_down ? c_white : c_black, 1)
		draw_sprite_ext(spr_mobilebuttons, 1, buttonspacing*3, 48, 1, 1, 0, obj_player.key_right ? c_white : c_black, 1)
				 
		draw_sprite_ext(spr_mobilebuttons, 4, buttonspacing*4, 48, 1, 1, 0, obj_player.key_jump ? c_white : c_black, 1)
		draw_sprite_ext(spr_mobilebuttons, 5, buttonspacing*5, 48, 1, 1, 0, obj_player.key_dash ? c_white : c_black, 1)
		draw_sprite_ext(spr_mobilebuttons, 6, buttonspacing*6, 48, 1, 1, 0, obj_player.key_run ? c_white : c_black, 1)
	}
